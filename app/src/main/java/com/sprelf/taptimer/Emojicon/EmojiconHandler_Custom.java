package com.sprelf.taptimer.Emojicon;
 ...
 *
 * THIS CLASS HAS BEEN COPIED AND MODIFIED FOR THE TAP TIMER APP
 */
public final class EmojiconHandler_Custom
{
    private EmojiconHandler_Custom()
    {
    }
...
//        Emoji.fromChars("\u0023\u20e3"),
    ...
    public static int getIcon(Context context, String text)
    {
        ...
        // THIS USED TO BE A LOOP.. BUT IT HAS BEEN REMOVED
        // for (int i = index; i < textLengthToProcess; i += skip) {
        // AS SUCH, SOME VARIABLES ARE REDUNDANT.  THIS COULD BE CLEANED UP
